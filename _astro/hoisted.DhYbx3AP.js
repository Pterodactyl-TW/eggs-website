import{R as b,f as E,b as a,r as v,g as k,c as T}from"./eggs-client.D32ovC1W.js";function $(n){return n?"✅":"❌"}function _(n){const o=n.slice(0,5),r=n.length-o.length,i=o.map(s=>{if(s.login)return`<a href="https://github.com/${a(s.login)}" target="_blank" rel="noopener" title="${a(s.login)}">
